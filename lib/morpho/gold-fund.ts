...
import { ETHEREUM_CHAIN_ID, XAUT } from "./gold-market";
...
// One priced leg. The shape moved to lib/trustware/eth-gas.ts with the gas
// planner; the name stays for the card and the check script.
export type GoldRouteLeg = TrustwareLeg;
