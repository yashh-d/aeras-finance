...
// Ondo's own candles on TradingView's Lightweight Charts.
//
...
// the mark price over Ondo's WebSocket (step 7), through the shared socket in
// lib/ondo/mark-socket.ts, folded into the last candle as it ticks. The socket
// is optional in effect: if it cannot connect, the chart is the history alone
// and thirty seconds behind.
//
...
export function OndoPerpsChart({ market }: { market: OndoMarket }) {
